...
class EpisodicLifeEnv(gym.Wrapper):
    ...
    def step(self, action):
        ...
        if lives < self.lives and lives > 0:
            ...
            the envirionment adverises done
            """
            done=True
        self.lives = lives
...
class MaxAndSkipEnv(gym.Wrapper):
    ...
    def reset(self):
        """
        Clear past frame buffer and init to first ob from inner env
        """
...
class FrameStack(gym.Wrapper):
    def __init__(self, env, k):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=255, shape=(shp[0], shp[1], shp[2]))
