...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        ...
        rectangle = PhotoImage(Image.open('../img/rectangle.png').resize((13, 13)))
        triangle = PhotoImage(Image.open('../img/triangle.png').resize((13, 13)))
        circle = PhotoImage(Image.open('../img/circle.png').resize((13, 13)))
